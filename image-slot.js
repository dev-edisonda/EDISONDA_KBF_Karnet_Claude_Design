...
(() => {
  ...
  const stylesheet =
    ...
    ':host([compact]) .empty{gap:0;padding:4px}' +
    ...
    ':host([no-controls]) .ctl{display:none!important}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">lub <u>wybierz plik</u></div></div>' +
    ...
    _render() {
      ...
      this._cap.textContent = this.getAttribute('placeholder') || 'Zdjęcie';
